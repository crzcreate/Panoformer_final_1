...
parser.add_argument("--learning_rate", type=float, default=1e-4, help="learning rate")#默认一开始是1e-4
parser.add_argument("--batch_size", type=int, default=2, help="batch size")
parser.add_argument("--num_epochs", type=int, default=300, help="number of epochs")

# loading and logging settings
parser.add_argument("--load_weights_dir", default="E:\PanoFormer-main\PanoFormer-main\PanoFormer\\tmp\\usefulinfo\his\weights_pretrain", type=str, help="folder of model to load")#, default='./tmp_abl_offset/panodepth/models/weights_49'
...
parser.add_argument("--save_frequency", type=int, default=2, help="number of epochs between each save")
