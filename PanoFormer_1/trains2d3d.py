...
# loading and logging settings E:\PanoFormer-main\PanoFormer-main\PanoFormer\\tmp_s2d3dtest\panodepth\models\\test.pth
parser.add_argument("--load_weights_dir", default="E:\PanoFormer-main\PanoFormer-main\PanoFormer\\tmp_s2d3dtest\panodepth\models\weights_pre", type=str, help="folder of model to load")#, default='./tmp_abl_offset/panodepth/models/weights_49'
...
parser.add_argument("--disable_LR_filp_augmentation",default=True,action="store_true",
                    help="if set, do not use left-right flipping augmentation")
parser.add_argument("--disable_yaw_rotation_augmentation",default=True,action="store_true",
